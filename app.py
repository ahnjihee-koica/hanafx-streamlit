...
st.set_page_config(page_title="하나은행 환율조회 자동화 (Lite Fixed)", page_icon="💱")
st.title("💱 하나은행 환율조회 자동화 (Lite Fixed)")
...
⚙️ 만약 오류가 발생하면, `error_debug.html` 파일을 확인하세요.
""")
...
if st.button("조회 및 엑셀 다운로드"):
    with st.spinner("조회 중입니다... (2~3초 소요)"):
        try:
